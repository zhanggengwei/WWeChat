...
- (UIButton *)registerBtn {
    if (!_registerBtn) {
        ...
        [_registerBtn setBackgroundImage:[UIImage yy_imageWithColor:BASE_COLOR] forState:UIControlStateNormal];
        [_registerBtn setBackgroundImage:[UIImage yy_imageWithColor:[UIColor colorWithRed:104/255.0 green:187/255.0 blue:30/255.0 alpha:0.5]] forState:UIControlStateDisabled];
        _registerBtn.enabled = NO;
    }
    return _registerBtn;
}
